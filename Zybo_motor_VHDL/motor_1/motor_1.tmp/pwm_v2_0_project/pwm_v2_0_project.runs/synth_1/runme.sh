...
HD_PWD='c:/users/zakhar/motor_1/motor_1.tmp/pwm_v2_0_project/pwm_v2_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_v2_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pwm_v2_0.tcl
