...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "GC_DEPTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "GC_WIDTH" -parent ${Page_0}


}

proc update_PARAM_VALUE.GC_DEPTH { PARAM_VALUE.GC_DEPTH } {
	# Procedure called to update GC_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GC_DEPTH { PARAM_VALUE.GC_DEPTH } {
	# Procedure called to validate GC_DEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.GC_DEPTH { MODELPARAM_VALUE.GC_DEPTH PARAM_VALUE.GC_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GC_DEPTH}] ${MODELPARAM_VALUE.GC_DEPTH}
}
