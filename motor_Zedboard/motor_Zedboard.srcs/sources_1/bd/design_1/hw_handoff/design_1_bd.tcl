...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins pwm_ip_0/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI] [get_bd_intf_pins rotary_encoder_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_ip_0/s00_axi_aclk] [get_bd_pins rotary_encoder_0/s00_axi_aclk] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net pwm_ip_0_pwm [get_bd_ports pwm] [get_bd_pins pwm_ip_0/pwm]
  connect_bd_net -net rotary_a_1 [get_bd_ports rotary_a] [get_bd_pins rotary_encoder_0/rotary_a]
  connect_bd_net -net rotary_b_1 [get_bd_ports rotary_b] [get_bd_pins rotary_encoder_0/rotary_b]
  connect_bd_net -net rotary_i_1 [get_bd_ports rotary_i] [get_bd_pins rotary_encoder_0/rotary_i]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins pwm_ip_0/s00_axi_aresetn] [get_bd_pins rotary_encoder_0/s00_axi_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rotary_encoder_0/S00_AXI/S00_AXI_reg] SEG_rotary_encoder_0_S00_AXI_reg
...
preplace port rotary_a -pg 1 -y 260 -defaultsOSRD
preplace port rotary_b -pg 1 -y 20 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 350 -defaultsOSRD
preplace port rotary_i -pg 1 -y 280 -defaultsOSRD
preplace port pwm -pg 1 -y 70 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 160 -defaultsOSRD
preplace inst rotary_encoder_0 -pg 1 -lvl 3 -y 230 -defaultsOSRD
preplace inst pwm_ip_0 -pg 1 -lvl 3 -y 70 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 160 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 410 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 NJ 330 NJ 330 NJ
...
preplace netloc pwm_ip_0_pwm 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 40 250 440
preplace netloc rotary_i_1 1 0 3 NJ 280 NJ 320 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 490 300 780
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 350 NJ 350 NJ
preplace netloc rotary_a_1 1 0 3 NJ 270 NJ 310 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 470
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 30 260 480 360 810
preplace netloc rotary_b_1 1 0 3 NJ 20 NJ 20 NJ
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 790
levelinfo -pg 1 0 240 630 930 1050 -top 0 -bot 540
",
}
